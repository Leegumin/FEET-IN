...
public class ProductService {
    ...
    public int store(String title, String model, String description, long price, String category, String colors, int discount, int percent, String saleYn, MultipartFile file) throws IOException {
        String fileName = StringUtils.cleanPath(file.getOriginalFilename());
//    todo: filedb 수정 (title, content)
        Product Product = new Product(fileName, title, model, description,price, category, colors, discount, percent, saleYn, file.getContentType(), file.getBytes());
