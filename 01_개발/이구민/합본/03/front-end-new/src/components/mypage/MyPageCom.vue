              ...
              <div class = "row align-items-center">
                ...
                <div class = "col-lg-9 px-xl-10 profile-content">
                  ...
                  <ul class = "list-unstyled">
                    <li class = "mb-2 mb-xl-2 display-28"><span class = "display-26">휴대폰 : </span>{{ currentUser.phone }}</li>
                    <li class = "mb-2 mb-xl-2 display-28"><span class = "display-26">이메일 : </span>{{ currentUser.email }}</li>
                    <li class = "mb-2 mb-xl-2 display-28"><span class = "display-26">우편번호 : </span>{{ currentUserAddress[0] }}</li>
                    <li class = "mb-2 mb-xl-2 display-28"><span class = "display-26">주소 : </span>{{ currentUserAddress[1] }} {{ currentUserAddress[3] }}</li>
