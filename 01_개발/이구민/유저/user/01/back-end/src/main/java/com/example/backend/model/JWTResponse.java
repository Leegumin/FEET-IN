...
public class JWTResponse {
    ...
    public JWTResponse(String token, String id, String username, String name, String birth, String email,
                       String address, String phone, List<String> roles, String deleteYn, String insertTime,
