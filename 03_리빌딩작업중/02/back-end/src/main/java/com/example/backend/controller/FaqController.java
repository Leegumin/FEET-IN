...
public class FaqController {
    ...
    @GetMapping("/faqs")
    public ResponseEntity<Map<String, Object>> getAllTitlePage(ProductCriteria productCriteria){



        try{
            List<Faq> faqs = faqService.findByTitleContaining(productCriteria);
            if(faqs.isEmpty()){
            ...
            response.put("currentPage", productCriteria.getPage());
            response.put("totalItems", productCriteria.getTotalItems());
            response.put("totalPage", productCriteria.getTotalPages());
