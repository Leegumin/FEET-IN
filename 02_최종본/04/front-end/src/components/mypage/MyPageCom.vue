    ...
    <div class="container mypage-container">
      <div class="row">
        ...
        <div class="col-lg-12 mb-4 mb-sm-5 cart-container" id="cart-page">
          <div>
            ...
            <table class="table mt-3 cart-table">
              ...
              <tr v-for="(cart, index) in carts" :key="index">
                ...
                <td class="td-center">{{ cart.title }}</td>
                <td class="td-center">{{ cart.shoseSize }}</td>
                <td class="td-center">
                ...
                <td class="td-center">{{ cart.finalPrice.toLocaleString() + "원" }}</td>
                <td class="td-center">
                  <button
          ...
          <div class="buy-btn-wrapper"><a class="buy-btn"
                                          @click="OnOrder"
          >
            구매하기</a>
          </div>
            ...
            <div class="box mt-3">
                <table class="table">
                  ...
                  <tr v-for="(order, index) in orders" :key="index">
                    ...
                    <td @click="showDetail(order.id)" class="text-start">
